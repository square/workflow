...
enum class BackStackConfig {
  ...
  /**
   * This rendering is the first frame in a [com.squareup.workflow.ui.BackStackScreen].
   * Useful as a hint to disable "go back" behavior, or replace it with "go up" behavior.
   */
  First,

  /**
   * This rendering is in a [com.squareup.workflow.ui.BackStackScreen]
   * but is not the first frame. Useful as a hint to enable "go back" behavior.
   */
  Other;
